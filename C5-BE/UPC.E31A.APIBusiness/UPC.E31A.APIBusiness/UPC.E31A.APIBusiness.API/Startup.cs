        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAuthentication("Bearer")
              .AddJwtBearer("Bearer", options =>
              {
                  ...
                  options.Audience = "API-APP-OSIPTEL";
              });
                ...
                c.SwaggerDoc(
                    ...
                    new OpenApiInfo
                    {
                        ...
                        Contact = new OpenApiContact()
                        {
                            ...
                            Url = new System.Uri("https://www.osiptel.gob.pe/"),
                            Email = "desarrollo@osiptel.gob.pe",
                        },
                        Description = AppSettingsProvider.config.ApplicationDescription,

                        License = new OpenApiLicense() { Name = AppSettingsProvider.config.OrganizationName, Url = new System.Uri("https://www.osiptel.gob.pe/") },
                        TermsOfService = new System.Uri("https://www.osiptel.gob.pe/")
                    });
